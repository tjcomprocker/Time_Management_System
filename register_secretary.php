    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <form action="register_secretary.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="executive_email_id">Executive Email ID:</label>
                        <input type="email" name="executive_email_id" required>
                    </div>
        ...
        <?php
            ...
            function submit()
            {
                ...
                $executive_flag = 0;
                $executive_email = $link->real_escape_string($_POST['executive_email_id']);
                $start_hour = $link->real_escape_string($_POST['start_hour']);
                $end_hour = $link->real_escape_string($_POST['end_hour']);
                
                
                $query   = "SELECT * from users WHERE email = \"" .$executive_email . "\";";
                ...
                if ($num_rows != 1) 
                {
                    echo "<div class=\"alert alert-danger\"><strong>Error!</strong>The executive ID entered does not exist.</div>";
                    die("");
                }
                ...
                {
                    echo "<div class=\"alert alert-danger\"><strong>Error!</strong>Both Passwords don't match.</div>";
                    die("");
                ...
                else
                {
                    ...
                    $query   = "INSERT into users VALUES('" . $email . "','" . $name . "','" . $password . "','" . $executive_flag . "','" . $executive_email . "','" . $start_hour . "','" . $end_hour. "');";
